				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<h1 class="fs-2">Login into Education!</h1>							
				<form method="post" action="LoginControlleur">					
					...
					<div class="wrap-input100 validate-input input-group input-group-lg mb-4" data-validate = "Password is required">
						...
						<input class="input100 form-control border-0 bg-light rounded-end ps-1" type="password" name="password" placeholder="Password">						
					</div>					
					<div class="container-login100-form-btn align-items-center mt-0">
									<div class="d-grid">
										<button class="login100-form-btn btn btn-primary mb-0" type="submit">Login</button>
									</div>
								</div>
				</form>
							...
							<div class="mt-4 text-center">
								<span>Don't have an account? <a href="Registration.jsp">Signup here</a></span>
							</div></div>							
							</div>							
						</div>
					</div> <!-- Row END -->
...
<!-- Mirrored from eduport.webestica.com/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Jun 2022 16:46:47 GMT -->
</html>
